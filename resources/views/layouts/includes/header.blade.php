<header class="header-content">
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
        <a href="<?= route('kinsmans.index') ?>" class="my-0 mr-md-auto font-weight-normal text-decoration-none">
            <span class="fs-4">{{ __('MainPage.Menu.Family') }}</span>
        </a>
        <a href="<?= route('kins.index') ?>" class="my-0 mr-md-auto font-weight-normal text-decoration-none">
